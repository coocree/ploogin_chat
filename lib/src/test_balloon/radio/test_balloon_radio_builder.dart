...
class TestBalloonRadioBuilder extends StatefulWidget {
  final List<TestBalloonRadioOption> options; // Lista de opções a serem exibidas
  ...
  const TestBalloonRadioBuilder({Key? key, required this.options, required this.onChanged, required this.rightAnswer}) : super(key: key);

  @override
  _TestBalloonRadioBuilderState createState() => _TestBalloonRadioBuilderState();
}

// State para gerenciar o estado interno do grupo de botões de rádio
class _TestBalloonRadioBuilderState extends State<TestBalloonRadioBuilder> {
